...
extern void compute_overlaps(princeton::TriMesh *s1, princeton::TriMesh *s2,
...
extern float ICP(princeton::TriMesh *s1, princeton::TriMesh *s2,
...
extern float ICP(princeton::TriMesh *s1, princeton::TriMesh *s2, const xform &xf1, xform &xf2,
		 int verbose = 0,
		 bool do_scale = false, bool do_affine = false);
